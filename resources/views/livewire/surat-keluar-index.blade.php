                                ...
                                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
                                            ...
                                            <div class="">
                                                <div class="mb-4">
                                                    <label for="exampleFormControlInput1"
                                                        class="block text-gray-700 text-sm font-bold mb-2 dark:text-white">{{ ucwords('dari bidang') }}
                                                        <small>(pisahkan dengan koma agar dapat diolah
                                                            sistem)</small>:</label>
                                                    <x-input-dropdown type="text"
                                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                        id="exampleFormControlInput1"
                                                        placeholder="Masukkan {{ ucwords('dari_bidang') }}"
                                                        wire:model="dari_bidang" rows="3" :data="$master_bidangs" />
                                                    @error('dari_bidang')
                                                ...
                                                <div class="mb-4">
                                                    <label for="exampleFormControlInput1"
                                                        class="block text-gray-700 text-sm font-bold mb-2 dark:text-white">{{ ucwords('surat kepada') }}:</label>
                                                    <input type="text"
                                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                        id="exampleFormControlInput1"
                                                        placeholder="Masukkan {{ ucwords('surat_kepada') }}"
                                                        wire:model="surat_kepada">
                                                    @error('surat_kepada')
                                                        <span class="text-red-500">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="mb-4">
                                                    <label for="exampleFormControlInput1"
                                                        class="block text-gray-700 text-sm font-bold mb-2 dark:text-white">{{ ucwords('keluar tgl') }}:</label>
                                                    <input type="date"
                                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                        id="exampleFormControlInput1"
                                                        placeholder="Masukkan {{ ucwords('keluar_tgl') }}"
                                                        wire:model="keluar_tgl">
                                                    @error('keluar_tgl')
                                                        <span class="text-red-500">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="mb-4">
                                                    <label for="exampleFormControlInput1"
                                                        class="block text-gray-700 text-sm font-bold mb-2 dark:text-white">{{ ucwords('alamat penerima') }}:</label>
                                                    <input type="text"
                                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                        id="exampleFormControlInput1"
                                                        placeholder="Masukkan {{ ucwords('alamat_penerima') }}"
                                                        wire:model="alamat_penerima">
                                                ...
                                                <div class="mb-4">
                                                    <label for="exampleFormControlInput1"
                                                        class="block text-gray-700 text-sm font-bold mb-2 dark:text-white">{{ ucwords('kode surat') }}:</label>
                                                    <select type="text"
                                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                        id="exampleFormControlInput1"
                                                        placeholder="Pilih {{ ucwords('kode_surat') }}"
                                                        wire:model="kode_surat">
                                                        <option value="">Pilih kode surat</option>
                                                        @foreach ($master_kode_surat as $item)
                                                        <option value="{{strtoupper($item->nama)}}">{{strtoupper($item->nama)}} - Kode : {{$item->kode}}</option>
                                    ...
                                    <div
                                        ...
                                        <span class="flex w-full rounded-md shadow-sm sm:mr-3 sm:w-auto">
                                            <button onclick="simpan('dari_bidang')" type="button" wire:loading.remove
...
@push('scripts')
    <script>
        ...
        window.livewire.on('update_dari_bidang', data => {
