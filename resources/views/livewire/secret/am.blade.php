    ...
    <script>
        var S = {
            init: function() {
                ...
                //Words to say
                S.UI.simulate(
                    "Hi Vira !|Diriku|Aditya Nanda|Mengucapkan|Selamat|Ulang|Tahun|Yang ke-{{ date('Y') - 1998 }}|#countdown 3|#time|#show-dialog"
                    );
                ...
                timedAction(function(index) {
                    ...
                    switch (action) {
                        ...
                        case 'rectangle':
                            ...
                            value = (value && value.length === 2) ? value : [maxShapeSize, maxShapeSize /
                            2];

                            S.Shape.switchShape(S.ShapeBuilder.rectangle(Math.min(maxShapeSize, parseInt(
                                value[0])), Math.min(maxShapeSize, parseInt(value[1]))));
                            break;
